    ...
    return (<FaqStyled id="faq">
        <Container>
            ...
            <div className="faq-body">
                ...
                <FaqSingle title="Can I get my money back if it doesn't work?" text="If you're not blown away by the results then we'll refund you fully!" />
            </div>
